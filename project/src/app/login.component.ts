...
@Component({
    ...
    <div class="page">
      ...
      <div class="left-panel">
        <div class="left-inner">
          ...
          <div class="left-body">
            <h2 class="left-title">Your Campus.<br>Your Marketplace.</h2>
            <p class="left-desc">Buy and sell textbooks, gadgets, and more — all within your college community.</p>
            <div class="feature-list">
              ...
              <div class="feature-item">
                ...
                <span>Safe campus exchanges</span>
              </div>
              <div class="feature-item">
                <div class="feature-icon">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="18" height="18"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                </div>
                <span>List items in seconds</span>
              </div>
            </div>
          </div>
      ...
      <div class="right-panel">
        <div class="form-card fade-in">
          ...
          <form (ngSubmit)="handleLogin()" class="auth-form" autocomplete="on">
            ...
            <div class="field-group">
              ...
              <div class="input-wrap">
                ...
                <input
                  ...
                  [(ngModel)]="email"
                  name="email"
                  placeholder="e.g. student@rathinam.in"
                  required
                  autocomplete="email"
                />
              </div>
  ...
  styles: [`
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .left-panel {
      width: 44%;
      background: linear-gradient(145deg, #3a3bc0 0%, #6b38d4 50%, #4648d4 100%);
      display: flex;
...
export class LoginComponent {
  ...
  async handleLogin() {
    ...
    if (!userVal || !emailVal) {
      this.error = 'Please enter both username and email address.';
      return;
    }

    this.loading = true;
    try {
      await this.authService.signIn(userVal, emailVal);
